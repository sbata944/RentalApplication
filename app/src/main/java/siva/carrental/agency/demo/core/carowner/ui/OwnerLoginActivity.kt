...
import siva.android.car.agency.databinding.ActivityOwnerLoginBinding
...
class OwnerLoginActivity : AppCompatActivity() {
    ...
    private lateinit var loginViewModel: OwnerLoginViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel = ViewModelProvider(this)[OwnerLoginViewModel::class.java]
        ...
        loginViewModel.loginResult.observe(this, Observer {
            ...
            if (loginResult.success != null) {
                ...
                val intent = Intent(this, CustomerDetailsListActivity::class.java)
                ...
                when (actionId) {
                    EditorInfo.IME_ACTION_DONE ->{}
                        /*loginViewModel.login(
                            username.text.toString(),
                            password.text.toString(), applicationContext
                        )*/
                }
                false
            }
        ...
        forgotPassword?.setOnClickListener {
            val intent = Intent(this, ResetOwnerPasswordActivity::class.java)
            startActivity(intent)
        }
    }
