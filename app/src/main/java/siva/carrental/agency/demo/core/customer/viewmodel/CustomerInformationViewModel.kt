 ...
 *
 */
class CustomerInformationViewModel(private val loginRepository: CustomerLoginRepository) :
    ViewModel() {
    ...
    fun getCarCustomersDetails(
        ...
        val result = loginRepository.getCarCustomersDetails(
            emailAddress,
            phoneNumber,
            customerID,
            password
    ...
    fun notifyToOwnerCrossedSpeedLimit(
        ...
        val result = loginRepository.notifyToOwnerCrossedSpeedLimit(
            emailAddress,
            phoneNumber,
            customerID,
            speed
